from FlyF.utils.rotas import distancia
from python_tsp.heuristics import solve_tsp_local_search
import numpy as np
from FlyF.utils.matriz import ler_matriz_arquivo


ler_matriz_arquivo(caminho="FlyF/entrada.txt")#Vai pegar o .txt e transformar em uma matriz
#No main tem que pôr qual o caminho desejado quando chamar a função
